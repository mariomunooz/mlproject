...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            # ensures that the directory for train_data_path exists, creating it and any necessary 
            # parent directories if they do not exist, without raising an error if it already exists.
